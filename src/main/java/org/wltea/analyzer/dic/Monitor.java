    ...
    public void runUnprivileged() {
        ...
        try {
            ...
            if (response.getStatusLine().getStatusCode() == 200) {
                ...
                if (((lastModifiedHeader != null) && !lastModifiedHeader.getValue().equalsIgnoreCase(last_modified))
                        || ((eTagHeader != null) && !eTagHeader.getValue().equalsIgnoreCase(eTags))) {
                    // 远程词库有更新,需要重新加载词典，并修改last_modified,eTags
                    Dictionary.getSingleton().reLoadMainDict();
                    last_modified = lastModifiedHeader == null ? null : lastModifiedHeader.getValue();
                    eTags = eTagHeader == null ? null : eTagHeader.getValue();
                }
